    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href=" {{ route('home') }} " class="flex ml-2 md:mr-24">
          <img src="{{ URL::to('/') }}/images/logo.jpeg" class="h-8 mr-3" alt="FlowBite Logo" />
          <!-- <span -->
          <!--   class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PHCL</span> -->
        </a>
      </div>
        ...
        <div class="flex items-center ml-3">
          <div>
            <button type="button"
              ...
              <img class="w-8 h-8 rounded-full" src="{{ URL::to('/') }}/images/logo.jpeg"
                alt="user photo">
            </button>
          </div>
          <div
