    ...
    <div
      ...
      <form action="{{ route('admin.medicines.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
              <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                  <div
                    ...
                    <input type="text" name="m_name" id="website"
              ...
              <div class="col-span-full">
                ...
                <div class="mt-2">
                  <textarea id="about" name="m_description" rows="3"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:text-sm sm:leading-6"></textarea>
                </div>
              ...
              <div class="sm:col-span-3">
                <label for="first-name"
                  ...
                  Price</label>
                <div class="mt-2">
                  <input type="number" name="m_price" id="first-name" autocomplete="given-name"
              ...
              <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                  <input type="number" name="m_quantity" id="m_quantity" autocomplete="family-name"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:text-sm sm:leading-6">
                </div>
              </div>
              <div class="sm:col-span-3">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
          ...
          <button type="submit"
            class="rounded-md bg-teal-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600">Save</button>
        </div>
      </form>
    </div>
  </div>
